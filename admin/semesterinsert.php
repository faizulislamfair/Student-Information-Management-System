    ...
    <tr>
      ...
      <td>
        ...
        <div style="margin-top:15px;" class="form-group">
          <input style="height:32px;" type="submit" value="Add" name="semester" class="btn btn-primary">
        </div>
...
<a href="semester-final.php"><button style="margin-left:750px; transform: translateY(-120px);" class="btn btn-primary">Back</button></a>



<footer style="margin-top:110px;" class="footer-area">
