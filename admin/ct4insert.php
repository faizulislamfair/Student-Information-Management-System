...
if(isset($_POST['ct4insert'])){
  ...
  $query = "INSERT INTO `student_marks4`(`Roll`, `Electrical_Machines`, `Data_Structure_&_Algorithms`, `Digital_Techniques`, `Mathematics`, `Chemistry`) VALUES ('$roll', '$elec', '$data', '$tech', '$math', '$chem')";

  $result = mysqli_query($link, $query);

  if($result){
   $success = "Data Insertion Successful!";
   header('location: ct4insert.php'); 
  } else {
    $error = "Wrong!";
  }
    ...
    <tr>
      ...
      <td>
        ...
        <div style="margin-top:15px;" class="form-group">
          <input style="height:32px;" type="submit" value="Add" name="ct4insert" class="btn btn-primary">
        </div>
