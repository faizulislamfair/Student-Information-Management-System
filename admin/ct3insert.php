...
if(isset($_POST['ct3insert'])){
  ...
  $query = "INSERT INTO `student_marks3`(`Roll`, `Electrical_Machines`, `Data_Structure_&_Algorithms`, `Digital_Techniques`, `Mathematics`, `Chemistry`) VALUES ('$roll', '$elec', '$data', '$tech', '$math', '$chem')";

  $result = mysqli_query($link, $query);

  if($result){
   $success = "Data Insertion Successful!";
   header('location: ct3insert.php'); 
  } else {
    $error = "Wrong!";
  }
    ...
    <tr>
      ...
      <td>
        ...
        <div style="margin-top:15px;" class="form-group">
          <input style="height:32px;" type="submit" value="Add" name="ct3insert" class="btn btn-primary">
        </div>
