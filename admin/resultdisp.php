...
?>
            ...
            else if(($ct1_2103 && $ct2_2103 && $ct3_2103) > $ct4_2103 ){
                $avg_1 = ($ct1_2103+$ct2_2103+$ct3_2103)/3;
            }
            else if(($ct1_2103 && $ct2_2103 && $ct4_2103) > $ct3_2103 ){
                $avg_1 = ($ct1_2103+$ct2_2103+$ct4_2103)/3;
            }
            else if(($ct1_2103 && $ct3_2103 && $ct4_2103) > $ct2_2103 ){
                $avg_1 = ($ct1_2103+$ct3_2103+$ct4_2103)/3;
            }
            else if(($ct2_2103 && $ct3_2103 && $ct4_2103) > $ct1_2103 ){
                $avg_1 = ($ct2_2103+$ct3_2103+$ct4_2103)/3;
            }
            ...
            else if(($ct1_2107 && $ct2_2107 && $ct3_2107) > $ct4_2107 ){
                $avg_2 = ($ct1_2107+$ct2_2107+$ct3_2107)/3;
            }
            else if(($ct1_2107 && $ct2_2107 && $ct4_2107) > $ct3_2107 ){
                $avg_2 = ($ct1_2107+$ct2_2107+$ct4_2107)/3;
            }
            else if(($ct1_2107 && $ct3_2107 && $ct4_2107) > $ct2_2107 ){
                $avg_2 = ($ct1_2107+$ct3_2107+$ct4_2107)/3;
            }
            else if(($ct2_2107 && $ct3_2107 && $ct4_2107) > $ct1_2107 ){
                $avg_2 = ($ct2_2107+$ct3_2107+$ct4_2107)/3;
            }
            ...
            else if($res2107>=40 && $res2107<=44){
                $gp2107 = 2.00;
            }
            else if($res2107>=45 && $res2107<=49){
                $gp2107 = 2.25;
            }
            else if($res2107>=50 && $res2107<=54){
                $gp2107 = 2.50;
            }
            else if($res2107>=55 && $res2107<=59){
                $gp2107 = 2.75;
            }
            else if($res2107>=60 && $res2107<=64){
                $gp2107 = 3.00;
            }
            else if($res2107>=65 && $res2107<=69){
                $gp2107 = 3.25;
            }
            else if($res2107>=70 && $res2107<=74){
                $gp2107 = 3.50;
            }
            else if($res2107>=75 && $res2107<=79){
                $gp2107 = 3.75;
            }
            else if($res2107>=80){
                $gp2107 = 4.00;
