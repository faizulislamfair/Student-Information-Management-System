...
<?php
		    ...
		    $db_31 = mysqli_query($link, "SELECT * FROM `semester_31` ");
...
<?php
		    ...
		    $db_32 = mysqli_query($link, "SELECT * FROM `semester_32` ");
...
<?php
       ...
       $db_41 = mysqli_query($link, "SELECT * FROM `semester_41` ");
...
<?php
       ...
       $db_42 = mysqli_query($link, "SELECT * FROM `semester_42` ");
