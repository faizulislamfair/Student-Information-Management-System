...
?>
  ...
  <tr>
    ...
    <td>
       <a href="ct2update.php?page=update-student&Roll=<?php echo base64_encode($row['Roll']); ?>" class="btn-xs btn-warning"><i class="fa fa-pencil"></i> Edit</a>
    </td>
  </tr>
...
<footer style="margin-top:25px;" class="footer-area">
