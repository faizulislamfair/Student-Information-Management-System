...
<div style="margin-top:15px; height:35px;" class="form-group">
          <input type="submit" value="Update" name="ct2update" class="btn btn-primary">
        </div>
...
<a href="ct2display.php"><button style="margin-left:1080px; transform: translateY(-125px);" class="btn btn-primary">Back</button></a>
