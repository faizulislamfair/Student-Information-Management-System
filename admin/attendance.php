...
<h1 class="text-primary text-center"><i class="far fa-address-card"></i> Attendance</h1>
...
<div class="jumbotron jumbotron-fluid">
 ...
 <div class="container">
   ...
   <div style="margin-left: 465px;" class="boxed">
     <h3>Attendance</h3>
	    <a href="attendanceinsert.php" style="margin-top:15px;" class="btn btn-primary offset-2">Insert</a> <br>
	    <a href="attendancedisplay.php" style="margin-top:15px;" class="btn btn-primary offset-2">Display</a> 
	    </a>
   </div>
